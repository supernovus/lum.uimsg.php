 ...
 * the Lum.Notifications library from Lum.js, or for a purely PHP rendered
 * notifications system.
 *
 * For CLI apps, the PHP version is probably your only option.
 * For Web apps, the JS version is highly recommended.
 */
class Notifications
{
  public $text;
  ...
  /**
   * Get the 'notifications' instance from the Lum PHP Session if it exists,
